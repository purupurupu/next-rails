...
RSpec.describe Api::V1::TagsController, type: :controller do
  ...
  describe 'GET #index' do
    ...
    it 'returns tags in ordered scope' do
      ...
      tag_old = create(:tag, user: user, created_at: 1.week.ago)
      tag_new = create(:tag, user: user, created_at: 1.day.ago)
  ...
  describe 'POST #create' do
    ...
    context 'with invalid params' do
      ...
      it 'allows duplicate names for different users' do
        other_tag = create(:tag, user: other_user, name: 'Shared Name')
